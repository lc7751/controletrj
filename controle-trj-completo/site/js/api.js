...
(function (TRJ) {
  ...
  A.getTasks      = function ()            { return call('getTasks'); };
  A.saveTasks     = function (rows)        { return call('saveTasks', { rows: rows || [] }); };
  A.getIncidents  = function ()            { return call('getIncidents'); };
  A.saveIncidents = function (rows)        { return call('saveIncidents', { rows: rows || [] }); };
  A.setIncidentStatus = function (items)   { return call('setIncidentStatus', { items: items || [] }); };
